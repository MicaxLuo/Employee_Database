...
// Online (Heroku) URL: https://fathomless-earth-33076.herokuapp.com/
...
app.use(clientSessions({
    ...
    secret: "web322_assignment6_xiaominluo", // this should be a long un-guessable string.
...
dataService.initialize()
    ...
    .then((data) => {
        app.listen(HTTP_PORT, portMessage(true));
    })
    .catch(() => {
        portMessage(false);
    })

var portMessage = (signal) => {
    if (signal) {
        console.log(`Express http server listening on port ${HTTP_PORT}`);
    } else {
        console.log(`Error initializing on port ${HTTP_PORT}`);
    }
};
